  ...
  const handleInputBlur = (field, value) => {
    ...
    switch (field) {
      ...
      case 'name':
        ...
        break;
      case 'employeeId':
        error = value.trim().length === 0 ? 'Employee ID is required' : '';
        break;
      case 'department':
        error = value.trim().length === 0 ? 'Department is required' : '';
        break;
    ...
    try {
      if (isLogin) {
        ...
        await signup(formData.email, formData.password, {
          name: formData.name,
          employeeId: formData.employeeId || `TEA${Date.now()}`,
      ...
      // Navigate to main tab navigator (will show teacher tabs)
      ...
      >
        ...
        >
          ...
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.logoSubtitle}>Educator Portal</Text>
          ...
          <View style={styles.tabContainer}>
            ...
            >
              <Ionicons 
                name="log-in-outline" 
                size={18} 
                color={isLogin ? "#059669" : "rgba(255,255,255,0.7)"} 
          ...
          <Animated.View style={[styles.formCard, formContainerStyle, formEntranceStyle]}>
            ...
            >
              <Text style={styles.welcomeTitle}>
                {isLogin ? 'Welcome Back' : 'Join as Educator'}
              </Text>
              <Text style={styles.welcomeSubtitle}>
                {isLogin 
                  ? 'Sign in to continue inspiring students' 
                  : 'Join our community of passionate educators'
                }
              </Text>

              {/* Form Fields */}
              <View style={styles.formFields}>            {/* Name Field - Only for Sign Up */}
            {!isLogin && (
            ...
            {/* Employee ID Field - Only for Sign Up */}
            {!isLogin && (
              <View style={styles.inputWrapper}>
                <View style={[
                  styles.inputContainer,
                  ...
                  <TextInput
                    ...
                    onBlur={() => {
                      setFocusedField(null);
                      handleInputBlur('employeeId', formData.employeeId);
                    }}
                    returnKeyType="next"
            ...
            {/* Department Field - Only for Sign Up */}
            {!isLogin && (
              <View style={styles.inputWrapper}>
                <View style={[
                  styles.inputContainer,
                  ...
                  <TextInput
                    ...
                    onBlur={() => {
                      setFocusedField(null);
                      handleInputBlur('department', formData.department);
                    }}
                    autoCapitalize="words"
                    returnKeyType="next"
                    onSubmitEditing={() => qualificationRef.current?.focus()}
                  />
                </View>
            ...
            {/* Qualification Field - Only for Sign Up */}
            {!isLogin && (
              <View style={styles.inputWrapper}>
                <View style={[
                  styles.inputContainer,
                  focusedField === 'qualification' && styles.inputFocused
                ]}>
          ...
          >
            <LinearGradient
              colors={isLoading ? ['#cbd5e1', '#94a3b8'] : ['#059669', '#047857', '#065f46']}
          ...
          {!isLogin && (
            <View style={styles.featuresContainer}>
              ...
              <View style={styles.featureItem}>
                ...
                <Text style={styles.featureText}>Content Management System</Text>
              </View>
              <View style={styles.featureItem}>
                <Ionicons name="chatbubbles-outline" size={16} color="#059669" />
                <Text style={styles.featureText}>Student Communication Tools</Text>
              </View>
            </View>
          )}
            </ScrollView>
