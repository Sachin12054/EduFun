...
const Grade3Home = ({ navigation }) => {
  ...
  // Grade 3 specific subjects - intermediate concepts
  const subjects = [
    { 
      id: 'maths', 
      ...
      description: 'Times tables & division facts',
      lessons: 22,
    ...
    { 
      ...
      description: 'Parts of speech & new words',
      lessons: 20,
    ...
    { 
      ...
      description: 'Maps, countries & past events',
      lessons: 16,
  ...
  // Grade 3 Quick Actions
  const quickActions = [
    { id: 1, title: 'Times Tables', icon: 'grid', color: '#667eea', screen: 'Dashboard' },
    { id: 2, title: 'Spelling Bee', icon: 'text', color: '#f093fb', screen: 'Dashboard' },
    { id: 3, title: 'Science Lab', icon: 'flask', color: '#4facfe', screen: 'Dashboard' },
    { id: 4, title: 'Quiz Time', icon: 'help-circle', color: '#fa709a', screen: 'Dashboard' },
  ];

  // Grade 3 Featured Content
  const featuredContent = [
    {
      id: 1,
      title: '✖️ Multiplication Magic',
      description: 'Master your 2, 5, and 10 times tables',
      image: '🔢',
      color: '#FF6B6B',
      difficulty: 'Medium',
      time: '12 min',
          ...
          >
            <View style={styles.headerContent}>
              <View style={styles.greetingSection}>
                ...
                <Text style={styles.gradeText}>Grade 3 • Discovering New Skills</Text>
              </View>
            ...
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statItem}>
                ...
                <Text style={styles.statLabel}>🎖️ Level</Text>
              </View>
            </View>
          </LinearGradient>
        </Animated.View>

        {/* Quick Actions for Grade 3 */}
        <Animated.View 
          style={[
            styles.section,
            { 
