...
const Grade4Home = ({ navigation }) => {
  ...
  // Grade 4 specific subjects - more advanced concepts
  const subjects = [
    { 
      id: 'maths', 
      ...
      description: 'Advanced number concepts',
      lessons: 24,
    ...
    { 
      ...
      description: 'Essays, poems & stories',
      lessons: 22,
    ...
    { 
      ...
      description: 'Forces, energy & matter',
      lessons: 20,
  ...
  // Grade 4 Quick Actions
  const quickActions = [
    { id: 1, title: 'Research Project', icon: 'search', color: '#667eea', screen: 'Dashboard' },
    { id: 2, title: 'Math Challenge', icon: 'trophy', color: '#f093fb', screen: 'Dashboard' },
    { id: 3, title: 'Science Fair', icon: 'beaker', color: '#4facfe', screen: 'Dashboard' },
    { id: 4, title: 'Book Report', icon: 'library', color: '#fa709a', screen: 'Dashboard' },
  ];

  // Grade 4 Featured Content
  const featuredContent = [
    {
      id: 1,
      title: '🔢 Fraction Adventures',
      description: 'Master halves, quarters & eighths',
      image: '🍕',
      color: '#FF6B6B',
      difficulty: 'Hard',
      time: '18 min',
    },
    {
      ...
      description: 'Journey through different countries',
      image: '🗺️',
      color: '#96CEB4',
      difficulty: 'Hard',
      time: '20 min',
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
            ...
            <View style={styles.headerContent}>
              <View style={styles.greetingSection}>
                ...
                <Text style={styles.userName}>
                  {userProfile?.name || 'Scholar'}
                </Text>
                <Text style={styles.gradeText}>Grade 4 • Advanced Learning</Text>
              </View>
        ...
        >
          <Text style={[styles.sectionTitle, { color: theme.text }]}>🎯 Advanced Tools</Text>
          <ScrollView 
            horizontal 
        ...
        >
          <Text style={[styles.sectionTitle, { color: theme.text }]}>📚 Advanced Studies</Text>
        ...
        >
          <Text style={[styles.sectionTitle, { color: theme.text }]}>🔥 Challenge Zone</Text>
